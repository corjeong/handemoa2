...
import adminreport.AdminPageDTO;
...
public class AdminCommentController {
	...
	public ModelAndView searchComment(int divisioncode, int currentpage, int search, String searchtxt) {
		...
		System.out.println(searchdetail.get("divisioncode"));
		System.out.println(searchdetail.get("pagestartrow"));
		System.out.println(searchdetail.get("limitrows"));
		System.out.println(searchdetail.get("search"));
		System.out.println(searchdetail.get("searchtxt"));
		...
		AdminPageDTO pagedto = new AdminPageDTO(limitRows, limitPage, currentpage, searchCommentRows);
